...
router.get('/', (req, res) => {
  const { producto_name, description, category_name, brand, model, stock } = req.query;
  db.consultable(producto_name, description, category_name, brand, model, stock)
    .then(data => {
...
router.post('/insert', (req, res) => {
  const {code, name, brand, model, description, stock, price, category_id} = req.body;
  console.log(code, name, brand, model, description, stock, price, category_id);
  tablas
  db.insertproducto(code, name, brand ,model, description, stock, price, category_id)
  .then(() => {
     res.redirect('index')
  })
  .catch(err => {
...
router.post('/edit/', (req, res)=>{
  const {id, code, name, brand, model, description, stock, price, category_id,} = req.body;
  tablas
  db.updateproducto(id, code, name, brand, model, description, stock, price, category_id)
  .then(() =>{
    res.redirect('/index');
    console.log(id, code, name, brand, model, description, stock, price, category_id);
  })
  .catch(err =>{
    console.log(err);
