...
let querys = {
    ...
    insertproducto: 'INSERT INTO producto (code, name, brand, model, description, stock, price, category_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?)',
    ...
    updateproducto: 'UPDATE producto SET code = ?, name = ?, brand = ?, model = ?, description = ?, stock = ?, price = ?, category_id = ? WHERE id = ?',
    ...
    getdetalles: 'SELECT producto.id AS producto_id, producto.name AS producto_name, producto.code AS producto_code, producto.price AS price, producto.description AS description, category.name AS category_name, producto.brand AS brand, producto.model AS model, producto.stock AS stock imagen.url AS imagen_url, imagen.id AS imagen_id FROM producto INNER JOIN category ON category.id = producto.category_id INNER JOIN imagen ON imagen.id = producto.id',
